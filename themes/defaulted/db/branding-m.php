<ul class="dropdown-menu pull-right">
  ...
  <li><a href="//plaza.quickbox.io/t/closing-marketplace-for-a-brief-time" target="_blank" alt="QuickBox Marketplace"><i class="fa fa-shopping-cart" style="color: #f1c40f"></i> Marketplace</a></li>
  <li><span style="margin-top:5x"></span></li>
